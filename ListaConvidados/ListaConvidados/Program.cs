...
namespace ListaDeConvidados
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Informe a idade convidado:");
            ...
            {
                Console.WriteLine("Parabéns, seja bem vido a festa");
            }
            else if (estaConvidado == false)
            {
                Console.WriteLine("Você não está na lista de convidados, favor verificar coma pessoa que te convidou");
            }
            else
            {
